                                ...
                                <div className="card" style={{ borderRadius: 10 }}>
                                    <div className="card-header px-4 py-5">
                                        <h5 className="text-muted mb-0">
                                            ...
                                            <span style={{ color: "#a8729a" }}>Tai</span>!
                                        </h5>
                                    </div>
                                            ...
                                            <div className="card shadow-0 border mb-4" key={randomId()}>
                                                <div className="card-body">
                                                    <div className="row">
                                                        ...
                                                        <div className="col-md-2 text-center d-flex justify-content-center align-items-center">
                                                            <p className="text-muted mb-0 small">{convertToUSD(product.product.price)}</p>
                                                        </div>
                                                    </div>
                                                    <hr
                                                        className="mb-4"
                                    ...
                                    >
                                        <h5 className="d-flex align-items-center justify-content-end text-white text-uppercase mb-0">
                                            Total paid: {convertToUSD(receipt.receipt_details.reduce((total, product) => {
                                                return total + product.quantity * product.product.price
                                            }, 0))}<span className="h2 mb-0 ms-2"></span>
                                        </h5>
                                    </div>
                                </div>
                            </div>
